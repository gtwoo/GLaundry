        ...
        <div class="col-lg-4 col-sm-6 col-xs-12">
            <div class="white-box analytics-info">
                ...
                <ul class="list-inline two-part">
                    ...
                    <li class="text-right"><i class="ti-arrow-up text-info"></i> <span class="counter text-info"><?= htmlspecialchars($hari['total']); ?></span></li>
                </ul>
            </div>
        </div>
    </div>
...
<br>
<div class="col-md-6">
    <a href="cetak.php" class="btn btn-primary box-title">Print</a>
</div>
<?php
