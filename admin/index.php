    ...
    <div class="row">
        <div class="col-lg-4 col-sm-6 col-xs-12">
            <div class="white-box analytics-info">
                ...
                <ul class="list-inline two-part">
                    <li>
                        <div id="sparkline"><img src="../assets/img/store.png"></div>
                    </li>
        ...
        <div class="col-lg-4 col-sm-6 col-xs-12">
            <div class="white-box analytics-info">
                ...
                <ul class="list-inline two-part">
                    <li>
                        <div id="sparkline1"><img src="../assets/img/user.png" alt=""></div>
                    </li>
        ...
        <div class="col-lg-4 col-sm-6 col-xs-12">
            <div class="white-box analytics-info">
                ...
                <ul class="list-inline two-part">
                    <li>
                        <div id="sparkline"><img src="../assets/img/money.png" alt=""></div>
                    </li>
